...
if __name__ == "__main__":
    env = RubiksCube2x2()
    agent, curriculum_state = RubikQLearningAgent.load("rubik_final.h5", env)
    if agent is None:
    ...
    ## uncomment to resume training (not recommended as agent already reached its peak with about 1M Episodes of training!!)
